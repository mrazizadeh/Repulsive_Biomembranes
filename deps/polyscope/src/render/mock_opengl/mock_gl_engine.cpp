...
void GLShaderProgram::setAttribute(std::string name, const std::vector<glm::vec2>& data, bool update, __attribute__((unused)) int  offset ,
                                   int size) {
  // Reshape the vector
...
void GLShaderProgram::setAttribute(std::string name, const std::vector<glm::vec3>& data, bool update, __attribute__((unused)) int offset,
                                   int size) {
  // Reshape the vector
  // Right now, the data is probably laid out in this form already... but let's
  // not be overly clever and just reshape it.
...
void GLShaderProgram::setAttribute(std::string name, const std::vector<glm::vec4>& data, bool update, __attribute__((unused)) int offset,
                                   int size) {
  // Reshape the vector
  // Right now, the data is probably laid out in this form already... but let's
  // not be overly clever and just reshape it.
...
void GLShaderProgram::setAttribute(std::string name, const std::vector<double>& data, bool update, __attribute__((unused)) int offset,
                                   int size) {
...
void GLShaderProgram::setAttribute(std::string name, const std::vector<int>& data, bool update, __attribute__((unused)) int offset, int size) {
...
void GLShaderProgram::setAttribute(std::string name, const std::vector<uint32_t>& data, bool update, __attribute__((unused)) int offset,
                                   int size) {
  // FIXME I've seen strange bugs when using int's in shaders. Need to figure
  // out it it's my shaders or something wrong with this function
